...
?>
    ...
    <div class="container">
        <div class="text-wrapper titleDashboard text-dark mt-5">
            <div class="letters mt-5">Tableau de Bord</div>
            <div class="line"></div>
        </div>
        ...
        <div class="row justify-content-center mt-5">
            <div class="col-sm-3 mb-3 mt-3 pl-5">
                <div class="card text-center">
                    <img src="../assets/autres/videoEtPhotoFondEcran/slr-camera-3752493_1920.jpg" alt="image d'un appareil photo" class="responsive pb-4">
            ...
            <div class="col-sm-3 mt-3 pl-5">
                <div class="card text-center">
                    <img src="../assets/autres/videoEtPhotoFondEcran/bag-1565402_1920.jpg" alt="image bloc note" class="responsive">
            ...
            <div class="col-sm-3 pl-5 mt-3 mb-3">
                <div class="card text-center">
                    <img src="../assets/autres/videoEtPhotoFondEcran/contact-5235117_1920.jpg" alt="image d'un bloc et un ordinateur" class="responsive">

                    <h5 class="card-title mt-3">Gestion des contact</h5>
                    <p class="card-text">
                    </p>
                    <a href="../view/view_listContact.php" type="imput" id="buttonAllPage" class="btn text-white">Consultez</a>
