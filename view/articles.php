            ...
            <div class="articles">
                <div class="mb-2">
                    <div class="row">
                        ...
                        <p class="text-justify">Une préstation photo lors d'une master class de Brook'Devis, le théme du jour "comment bien
                            faire ses ciles"
                    ...
                    <div class="row">
                        ...
                        <p class="text-justify">Le shooting photo des mannequins de la marque NSNV, une marque de vêtement de mon frére, NSNV
                            est une marque
                    ...
                    <div class="row">
                        ...
                        <p class="text-justify">shooting photo sur paris, c'était ma grande premiere. séance photos pour un groupe d'amies,
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                    ...
                    <div class="row text-center ml-5">
                                        ...
                                        <div class="ml-3">
                                            <a href="mailto:aisetoutoure@gmail.com"><svg
