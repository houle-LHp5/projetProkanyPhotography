...
<body>
    ...
    <nav aria-label="navigation">
        <div class="pager">
            <a href="portrait.php" class="bg-dark text-white float-left" title="Précédent">Précédent</a>
            <a href="articles.php" class="bg-dark text-white float-right" title="Suivant">Suivant</a>
        </div>
    </nav>
